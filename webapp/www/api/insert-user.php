<?php 
    ...
    try {
        ...
        // insert the user
        $sql = $db->prepare("INSERT INTO user (username, pretty_name, start_value, account_status) VALUES (?, ?, ?, ?)");
        $sql->bind_param('ssds', $_POST["inputUsername"], $pretty_name, $start_value, $_POST['inputAccountStatus']);
        $sql->execute();
        $sql->free_result();
